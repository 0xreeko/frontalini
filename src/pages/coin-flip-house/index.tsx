...
import FooterHouse from '../../components/FooterHouse'
import Container from '../../components/Container'
import { useRounds } from '../../hooks/useCoinTossHouse'
import Modal from '../../components/ClaimModal'
import { useActiveWeb3React } from '../../hooks/useActiveWeb3React'

export default function CoinFlipHouse() {
  ...
  return (
    <>
      <Container id="house-page" className="flex-1" maxWidth="full">
        <ToastContainer />
        <Head>
          <title>OneFortune - Coin Flip House</title>
          <meta key="description" name="description" content="Coin Flip House" />
        </Head>
        ...
        <div className="pt-4 md:pt-10 theGamesBack">
          <div className="flex w-screen">
            <div className="flex-auto mb-4 ml-4 sm:ml-10">
              ...
              <span className="font-sans text-lg md:text-2xl text-cF0EFEE">Coin Flip House</span>
            </div>
            <div className="flex-auto pr-4 mb-4 ml-4 text-right sm:pr-10">
              <a href="https://docs.onefortune.com/coin-flip-house/house-version" target="_blank" rel="noreferrer">
          ...
          {modalShow ? (
            <Modal onClose={() => setModalShow(false)}>
              <div className="flex items-center content-center justify-center w-full h-full mx-auto">
                <div className="w-full overflow-hidden sm:w-110 rounded-2xl bg-c18222E z-[61]">
            ...
            <div className="flex justify-between min-h-[80%] mb-2">
              {account ? (
                <Swiper slidesPerView={'auto'} spaceBetween={30} centeredSlides={true} initialSlide={5}>
                  {rounds.map((item, index) => (
                    <SwiperSlide key={index}>
                      <House item={item} swiperIndex={index} />
                    </SwiperSlide>
                  ))}
                </Swiper>
              ) : (
