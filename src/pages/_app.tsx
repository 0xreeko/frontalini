  ...
  return (
    <Fragment>
      <Head>
        ...
        />
        <title key="title">OneFortune - P2E GameFi Platform</title>

        <meta
          key="description"
          name="description"
          content="The pioneering play-to-earn GameFi platform on Polygon. Fortune favors the BOLD."
        />

        <meta name="application-name" content="OneFortune - P2E GameFi Platform" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
        <meta name="apple-mobile-web-app-title" content="OneFortune - P2E GameFi Platform" />
        ...
        <meta key="twitter:title" name="twitter:title" content="OneFortune - P2E GameFi Platform" />
        <meta
          key="twitter:description"
          name="twitter:description"
          content="The pioneering play-to-earn GameFi platform on Polygon. Fortune favors the BOLD."
        />
        <meta key="twitter:creator" name="twitter:creator" content="@onefortune_" />
        <meta key="og:type" property="og:type" content="website" />
        <meta key="og:site_name" property="og:site_name" content="OneFortune - P2E GameFi Platform" />
        <meta
          key="og:description"
