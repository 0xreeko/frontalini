        ...
        <div className="flex flex-col space-y-6">
          ...
          {walletView !== WALLET_VIEWS.PENDING && (
            <div className="flex flex-col text-center">
              <div className="text-secondary">{i18n._(t`Playing on a mobile device?`)}</div>
              <ExternalLink
                href="https://docs.onefortune.com/using-the-platform/using-onefortune-on-mobile-devices"
                color="blue"
              >
                {i18n._(t`Learn more about how to connect`)}
              </ExternalLink>
            </div>
          )}
        </div>
