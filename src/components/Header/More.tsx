...
const items = (i18n: I18n) => [
  {
    name: i18n._(t`Docs`),
    description: i18n._(t`Documentation for users of CoinToss.`),
    href: 'https://docs.sushi.com',
    external: true,
  },
  {
    name: i18n._(t`Dev`),
    description: i18n._(t`Documentation for developers of CoinToss.`),
    href: 'https://dev.sushi.com',
    external: true,
  },
  {
    name: i18n._(t`Open Source`),
    description: i18n._(t`CoinToss is a supporter of Open Source.`),
  ...
  },
  {
    ...
    href: 'https://discord.gg/bcaRExwZFe',
    external: true,
  },
  {
