...
const TossHouseUpComing: React.FC<Props> = ({ roundId, timeRemain }) => {
      ...
      <div className="flex flex-col justify-center px-4 h-70">
        <div className="box-border border bg-c111822 h-44 rounded-xl border-cF0EFEE">
          <div className="flex flex-col items-center justify-center h-full">
            ...
            <div className="flex items-center text-2xl font-medium text-blue-gray-600">
              {time >= 1 && <Image src="/images/toss/clock.png" alt="head" width="19.46px" height="19.46px" />}
...
export default TossHouseUpComing
