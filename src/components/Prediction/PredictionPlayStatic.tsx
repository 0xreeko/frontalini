...
const PredictionPlayStatic: React.FC<Props> = ({
  timeRemain,
  roundId,
  winAmount,
  winSymbol,
  ...
  const [timeRemainText, setTimeRemainText] = useState('IN PLAY')

  const toggleWalletModal = useWalletModalToggle()

  useEffect(() => {
    setTimeRemainText('IN PLAY')
  }, [time])
...
export default PredictionPlayStatic
