...
function useTokenBalance(tokenAddress: string, abi?: any): BalanceProps {
  ...
  const tokenContract = useContract(addressCheckSum ? addressCheckSum : undefined, abi ? abi : ERC20_ABI, false)
